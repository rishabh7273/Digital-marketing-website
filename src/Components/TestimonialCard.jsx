...
export default function TestimonialCard({ image, title, description }) {
  return (
    <div className="w-[300px] bg-white border border-gray-200 rounded-xl p-4 shadow-md hover:shadow-lg transition-shadow duration-300">
      ...
      {/* Description */}
      <p className="mt-1 text-gray-600 text-sm leading-relaxed line-clamp-4">
        {description}
      </p>
    </div>
  );
